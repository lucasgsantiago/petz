...
public interface IClienteControllerDocs {
    ...
    ClienteDetalheResponse obterCliente(@PathVariable String id) throws ClienteNotFoundException;
    ...
    ResponseEntity<PetDetalheResponse> obterPetPorId(@PathVariable String id, @PathVariable String petId) throws ResourceNotFoundException;
